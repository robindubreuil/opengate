...
When the very fist release will be considered production ready, batches will be manufactured and sold commercially by the ![project author](https://github.com/robindubreuil) through a dedicated website. This will guarantee the best quality possible at a fair price for everyone.
In the meantime, you can reach ![the author](https://github.com/robindubreuil) if you are interested to get your hands on a prototype, or pre-order your production grade unit.
...
OpenGate is an open-source project, and we welcome contributions from the community. You can contribute by reporting issues, suggesting improvements, or submitting pull requests on our [GitHub repository](https://github.com/robindubreuil/opengate/).
